...
//   svgElm: React.ReactNode;
//   options;
//   axis;
//   data;
// }

// export function ChartCursor({ svgElm, options, axis, data }: IChartCursorProps) {
...
//   function createRoundRect(x: number, y: number, w: number, h: number, r: number) {
//     return `
...
//           return (
//             <text className='chart1i0i0-note_text' key={i} x={pos.x + options.axisTxtOffs} y={pos.y + hStr + i * hStr} fill={el.clr}>
//               {el.txt}{' '}
//             </text>
//           );
//         })}
