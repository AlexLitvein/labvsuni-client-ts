...
export const Header = ({ currSensData }: IHeaderProps) => {
  return (
    <Stack sx={{ flexDirection: 'row', alignItems: 'end', p: 1, backgroundColor: '#3bc3e3' }}>
      <Typography sx={{ mr: '-1.3em', mb: '0.9em', ml: '-1.5em', lineHeight: '1em', textAlign: 'end', transform: 'rotate(-90deg)' }}>
        Погода&nbsp;в
        <br />
        городе
      </Typography>
      <Typography sx={{ fontSize: '4rem', pl: '0.14em', ml: '-0.13em', lineHeight: '0.8em', borderBottom: 8 }}>Ю</Typography>
      ...
      <CurrSensDataCard currSensData={currSensData} />
    </Stack>
  );
};
